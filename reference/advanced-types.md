...
# layout: docs
# permalink: /handbook/advanced-types.html
# oneline: Advanced concepts around types in TypeScript
# deprecated_by: /handbook/types-from-types.html

# prettier-ignore
# deprecation_redirects: [
#   type-guards-and-differentiating-types, /handbook/narrowing.html,
#   user-defined-type-guards, /handbook/narrowing.html#using-type-predicates,
#   typeof-type-guards, "/handbook/narrowing.html#typeof-type-guards",
#   instanceof-type-guards, /handbook/narrowing.html#instanceof-narrowing,
#   nullable-types, /handbook/everyday-types.html#null-and-undefined,
#   type-aliases, /handbook/everyday-types.html#type-aliases,
#   interfaces-vs-type-aliases, /handbook/everyday-types.html#differences-between-type-aliases-and-interfaces,
#   enum-member-types, /handbook/enums.html,
#   polymorphic-this-types, /handbook/classes.html,
#   index-types, /handbook/objects.html#index-signatures,
#   index-types-and-index-signatures, /handbook/indexed-access-types.html,
#   mapped-types, /handbook/mapped-types.html,
#   inference-from-mapped-types, /handbook/mapped-types.html,
#   conditional-types, /handbook/conditional-types.html,
#   distributive-conditional-types, /handbook/conditional-types.html#distributive-conditional-types,
#   type-inference-in-conditional-types, /handbook/conditional-types.html#inferring-within-conditional-types,
#   predefined-conditional-types, /handbook/utility-types.html,
#   using-the-in-operator, "/handbook/narrowing.html#the-in-operator-narrowing",
#   using-type-predicates, "/handbook/narrowing.html#using-type-predicates"
# ]
---

This page lists some of the more advanced ways in which you can model types, it works in tandem with the [Utility Types](/handbook/utility-types.html) doc which includes types which are included in TypeScript and available globally.
...
We mentioned these briefly in [the Basic Types section](/handbook/basic-types.html).
...
From TypeScript 3.7 and onwards, you can use [optional chaining](/handbook/release-notes/typescript-3-7.html#optional-chaining) to simplify working with nullable types.
...
Together with [intersection](/handbook/unions-and-intersections.html) types, we can make some pretty mind-bending types:
...
TypeScript adds several predefined conditional types, you can find the full list and examples in [Utility Types](/handbook/utility-types.html).
