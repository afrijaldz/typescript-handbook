...
Be aware, however, that object literals [may only specify known properties](/handbook/objects.html#excess-property-checks).
...
Reiterating [The Basics](/handbook/basic-types.html):
